...
E1  & \statusscaffold & Matched-fold head-to-head &
      M0097: $T{=}0.1$ 5.0 passing / 1.0 cluster per 8 folds; \cleo{} 3.1 / 3.1 \\
...
E10 & \statusblocked  & \textbf{Temperature sweep} $T \in \{0.1, \ldots, 1.0\}$;
      builds the incumbent frontier & \todoresult \\
...
E14 & \statusblocked  & ESM embedding view of the passing libraries & \todoresult \\
