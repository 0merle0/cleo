"""PDB parsing, writing, amino acid mappings, and RMSD computation.

Provides utilities for reading PDB files into coordinate arrays, writing
PDB files from atom tensors, computing RMSD via SVD alignment, and
standard amino acid lookup tables (1-letter, 3-letter, numeric encoding,
and full sidechain atom names).
"""
import numpy as np
import torch
